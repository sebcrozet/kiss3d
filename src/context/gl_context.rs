...
impl AbstractContextConst for GLContext {
    ...
    const TEXTURE_CUBE_MAP: u32 = gl::TEXTURE_CUBE_MAP;
    const TEXTURE_CUBE_MAP_POSITIVE_X: u32 = gl::TEXTURE_CUBE_MAP_POSITIVE_X;
    const TEXTURE_CUBE_MAP_NEGATIVE_X: u32 = gl::TEXTURE_CUBE_MAP_NEGATIVE_X;
    const TEXTURE_CUBE_MAP_POSITIVE_Y: u32 = gl::TEXTURE_CUBE_MAP_POSITIVE_Y;
    const TEXTURE_CUBE_MAP_NEGATIVE_Y: u32 = gl::TEXTURE_CUBE_MAP_NEGATIVE_Y;
    const TEXTURE_CUBE_MAP_POSITIVE_Z: u32 = gl::TEXTURE_CUBE_MAP_POSITIVE_Z;
    const TEXTURE_CUBE_MAP_NEGATIVE_Z: u32 = gl::TEXTURE_CUBE_MAP_NEGATIVE_Z;
    ...
    const TEXTURE_WRAP_R: u32 = gl::TEXTURE_WRAP_R;

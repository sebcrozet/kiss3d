...
use nprocgen::mesh::{ProceduralGenerator, CapsuleGenerator, QuadGenerator, TriMesh};
use nprocgen::mesh;
use scene::Object;
use camera::Camera;
use light::Light;
...
impl SceneNode {
    ...
    pub fn add_from_generator<G: ProceduralGenerator<f32, Vec3<f32>>>(
                              &mut self,
                              generator: &G,
                              scale:     Vec3<f32>) -> SceneNode {
        self.add_trimesh(generator.generate(), scale)
    }

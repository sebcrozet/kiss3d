...
fn main() {
    ...
    teapot.append_translation(&Vector3::new(0.0, -0.05, -0.2));
    ...
    rust.prepend_to_local_rotation(&Vector3::new(-1.0 * f32::consts::FRAC_PI_2, 0.0, 0.0));
    rust.set_color(0.0, 0.0, 1.0);

    window.set_light(Light::StickToCamera);

    while window.render() {
        teapot.prepend_to_local_rotation(&Vector3::new(0.0f32, 0.014, 0.0));
        rust.prepend_to_local_rotation(&Vector3::new(0.0f32, -0.014, 0.0));
    }
}

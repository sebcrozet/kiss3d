...
fn main() {
     ...
     * A cube.
     */
    let cube  = ncollide_procedural::cuboid(&Vector3::new(0.7f32, 0.2, 0.4));
    let mut c = window.add_trimesh(cube, na::one());
    c.append_translation(&Vector3::new(1.0, 0.0, 0.0));
    ...
    let to_triangulate = ncollide_transformation::triangulate(&[
        Point3::new(5.0f32, 0.0, 0.0), Point3::new(6.1, 0.0, 0.5), Point3::new(7.4, 0.0, 0.5), Point3::new(8.2, 0.0, 0.0),
        Point3::new(5.1f32, 1.0, 0.0), Point3::new(6.2, 1.5, 0.5), Point3::new(7.2, 1.0, 0.5), Point3::new(8.0, 1.3, 0.0),
        Point3::new(5.3f32, 2.0, 0.0), Point3::new(6.1, 2.2, 0.5), Point3::new(7.3, 2.0, 0.5), Point3::new(8.2, 2.4, 0.0),
        Point3::new(5.2f32, 3.0, 0.0), Point3::new(6.1, 2.9, 0.5), Point3::new(7.4, 3.0, 0.5), Point3::new(8.0, 3.1, 0.0)
    ]);
     ...
     */
    let control_points = [
        Point3::new(0.0f32, 0.0, 0.0), Point3::new(1.0, 0.0, 2.0), Point3::new(2.0, 0.0, 2.0), Point3::new(3.0, 0.0, 0.0),
        Point3::new(0.0f32, 1.0, 2.0), Point3::new(1.0, 1.0, 3.0), Point3::new(2.0, 1.0, 3.0), Point3::new(3.0, 1.0, 2.0),
        Point3::new(0.0f32, 2.0, 2.0), Point3::new(1.0, 2.0, 3.0), Point3::new(2.0, 2.0, 3.0), Point3::new(3.0, 2.0, 2.0),
        Point3::new(0.0f32, 3.0, 0.0), Point3::new(1.0, 3.0, 2.0), Point3::new(2.0, 3.0, 2.0), Point3::new(3.0, 3.0, 0.0)
    ];
    let bezier = ncollide_procedural::bezier_surface(&control_points, 4, 4, 100, 100);
    let mut b  = window.add_trimesh(bezier, na::one());
    b.append_translation(&Vector3::new(-1.5, -1.5, 0.0));
    ...
    control_polyhedra_gfx.append_translation(&Vector3::new(-1.5, -1.5, 0.0));
    ...
    control_points_gfx.append_translation(&Vector3::new(-1.5, -1.5, 0.0));
    ...
    m.append_translation(&Vector3::new(4.0, -1.0, 0.0));
    ...
    mhull.append_translation(&Vector3::new(0.0, 2.0, -1.0));
    ...
    mpts.append_translation(&Vector3::new(0.0, 2.0, -1.0));
...
fn draw_polyline(window: &mut Window, polyline: &Polyline<Point2<f32>>, points: &[Point2<f32>]) {
    for pt in polyline.coords().windows(2) {
        window.draw_line(&Point3::new(pt[0].x, pt[0].y, 0.0), &Point3::new(pt[1].x, pt[1].y, 0.0), &Point3::new(0.0, 1.0, 0.0));
    }

    let last = polyline.coords().len() - 1;
    window.draw_line(&Point3::new(polyline.coords()[0].x, polyline.coords()[0].y, 0.0),
